			...
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
				...
				<div class="form_content clearfix">
					...
					<div class="form-group">
						...
						<input style="text-transform: lowercase;" type="email" class="is_required validate account_input form-control" data-validate="isEmail" id="email_create" name="email_create" value="{if isset($smarty.post.email_create)}{$smarty.post.email_create|stripslashes}{/if}" />
					</div>
					<div class="submit">
			...
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
				...
				<div class="form_content clearfix">
					<div class="form-group">
						...
						<input style="text-transform: lowercase" class="is_required validate account_input form-control" data-validate="isEmail" type="email" id="email" name="email" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" />
					</div>
					<div class="form-group">
				...
				<div id="opc_account_form" style="display: block; ">
					...
					{foreach from=$dlv_all_fields item=field_name}
						...
						{elseif $field_name eq "vat_number"}
							...
							<div class="dni form-group">
								<label for="dni">{l s='Identification number'} <sup>*</sup></label>
								<input type="text" name="dni" id="dni" value="{if isset($smarty.post.dni)}{$smarty.post.dni}{/if}" style="text-transform: uppercase;"/>
								<span class="form_info">{l s='DNI / NIF / NIE'}</span>
								<span class="form_info">{l s='Fill this field if you want invoices of your orders'}</span>
							</div>
					...
					{if $dniExist eq false}
						<div class="form-group dni">
							<label for="dni">{l s='Identification number'} <sup>*</sup></label>
							<input type="text" class="text form-control" name="dni" id="dni" value="{if isset($smarty.post.dni) && $smarty.post.dni}{$smarty.post.dni}{/if}" style="text-transform: uppercase;"/>
							<span class="form_info">{l s='DNI / NIF / NIE'}</span>
							<span class="form_info">{l s='Fill this field if you want invoices of your orders'}</span>
						</div>
					{/if}
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form">
		...
		{assign var=USER_REGISTRATION_TPL value="`$GDPR_TEMPLATE_PATH`/user_registration.tpl"}
		{include file=$USER_REGISTRATION_TPL}
		{$HOOK_CREATE_ACCOUNT_FORM}
	</form>
{/if}
{strip}
