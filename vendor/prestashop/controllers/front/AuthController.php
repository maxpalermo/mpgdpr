...
require_once _PS_MODULE_DIR_.'mpgdpr/classes/MpGdprTools.php';
require_once _PS_MODULE_DIR_.'mpgdpr/classes/MpGdprProcessPageEraseData.php';
...
class AuthControllerCore extends FrontController
{
    ...
    private function processPageEraseData()
    {
        ...
        return "<h1>Customer id: ".$id_customer."</h1>";
    }
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign('bootstrap4', $url);
        /** END BOOTSTRAP */
        ...
        $this->context->smarty->assign(
            array(
                ...
                'GDPR_TEMPLATE_PATH' => _PS_MODULE_DIR_.'mpgdpr/views/templates/front/',
            )
        );

        // Just set $this->template value here in case it's used by Ajax
        //$this->setTemplate(_PS_THEME_DIR_.'authentication.tpl');
        $this->context->smarty->assign('email_customer', Tools::getValue('email_create'), '');
        $this->context->smarty->assign('countries_list', MpGdprTools::getCountriesList());
        $this->context->smarty->assign('job_areas', MpGdprObjectModelCustomerJobArea::getList());
        $this->setTemplate(_PS_MODULE_DIR_.'mpgdpr/views/templates/front/authentication.tpl');
    ...
    protected function processSubmitAccount()
    {
        ...
        /** SAVE CUSTOMER DATA **/
        $customer = MpGdprTools::processSubmitAccount($this);
        /***********************/
        if ($customer) {
            ...
            $this->errors[] = Tools::displayError('Unable to add cusomer.');
            return false;
        }
        ...
        if (!Configuration::get('PS_REGISTRATION_PROCESS_TYPE') && !$this->ajax && !Tools::isSubmit('submitGuestAccount')) {
            ...
            foreach ($addresses_types as $addresses_type) {
                ...
                if ($country->need_identification_number && (!Tools::getValue('dni') || !Validate::isDniLite(Tools::getValue('dni')))) {
					...
					if(!preg_match('/^[a-z]{6}[0-9]{2}[a-z][0-9]{2}[a-z][0-9]{3}[a-z]$/i', trim(Tools::getValue('dni')))) {
						$this->errors[] = Tools::displayError('The identification number is not valid.');
                    }
                }
